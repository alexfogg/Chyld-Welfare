  ...
  describe 'User create form' do
      ...
      it 'after filling the form and clicking create account, user should be createsd',:js => true do
          ...
          click_button('Create Account')
            #Tests
            page.should have_text('You have created an account!') #testing to make sure you have confirmation showing
            ...
            expect(User.first.user.username).to eq 'Bob' #testing to make sure it's in database (this should happen before the above but it might cause a race condition)
      end
